...
(defn
 ...
 ([x]
  (let
   [original-result__41413__auto__ (tech.v3.datatype.functional/+ x)]
   (if
    (clojure.core/->
     original-result__41413__auto__
     tech.v3.datatype.argtypes/arg-type
     (clojure.core/= :reader))
    (tablecloth.column.api/column original-result__41413__auto__)
    original-result__41413__auto__)))
 ([x y]
  (let
   [original-result__41413__auto__ (tech.v3.datatype.functional/+ x y)]
   (if
    (clojure.core/->
     original-result__41413__auto__
     tech.v3.datatype.argtypes/arg-type
...
(defn
 ...
 ([col percentiles]
  (let
   [original-result__41298__auto__
