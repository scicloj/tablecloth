...
(defn
 ...
 ([x options]
  (let
   [original-result__47788__auto__
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/log x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x y]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/< x y)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/sq x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/sum x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/min x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/cos x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/tan x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/exp x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/not x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__47788__auto__
    (clojure.core/apply tech.v3.datatype.functional/equals x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([arg options]
  (let
   [original-result__47788__auto__
    (tech.v3.datatype.functional/round arg options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__)))
 ([arg]
  (let
   [original-result__47788__auto__
    (tech.v3.datatype.functional/round arg)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/abs x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/max x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/ulp x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__47788__auto__ (tech.v3.datatype.functional/sin x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__47788__auto__))))
