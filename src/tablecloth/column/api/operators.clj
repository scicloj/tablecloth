...
(defn
 ...
 ([col]
  (let
   [original-result__39477__auto__
...
(defn
 ...
 ([lhs rhs]
  (let
   [original-result__39478__auto__
 ...
 *
 ...
 ([x y]
  (let
   [original-result__39478__auto__ (tech.v3.datatype.functional/* x y)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__39478__auto__)))
 ([x y & args]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__39478__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__39478__auto__)))
 ([x y]
  (let
