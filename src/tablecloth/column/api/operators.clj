...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/log x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/sq x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__))))
 ...
 *
 ...
 ([x y]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/* x y)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__)))
 ([x y & args]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/min x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/cos x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/tan x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/exp x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/abs x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/max x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/ulp x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__44926__auto__ (tech.v3.datatype.functional/sin x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__44926__auto__))))
