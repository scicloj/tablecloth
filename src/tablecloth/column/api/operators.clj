...
(defn
 ...
 ([col]
  (let
   [original-result__26254__auto__
...
(defn
 ...
 ([x y]
  (let
   [original-result__26255__auto__
 ...
 *
 ...
 ([x y]
  (let
   [original-result__26255__auto__ (tech.v3.datatype.functional/* x y)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__26255__auto__)))
 ([x y & args]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__26255__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__26255__auto__)))
 ([x y]
  (let
