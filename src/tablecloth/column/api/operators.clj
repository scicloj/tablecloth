...
(defn
 ...
 ([col]
  (let
   [original-result__43457__auto__
...
(defn
 ...
 ([lhs rhs]
  (let
   [original-result__43458__auto__
...
(defn
 ...
 ([x]
  (let
   [original-result__43458__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__43458__auto__)))
 ([x y]
  (let
   [original-result__43458__auto__ (tech.v3.datatype.functional/- x y)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__43458__auto__)))
 ([x y & args]
  (let
