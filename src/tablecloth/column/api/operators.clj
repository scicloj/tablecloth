...
(defn
 ...
 ([col]
  (let
   [original-result__41913__auto__
 ...
 *
 ...
 ([x y]
  (let
   [original-result__41914__auto__ (tech.v3.datatype.functional/* x y)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__41914__auto__)))
 ([x y & args]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__41914__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__41914__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x y]
  (let
   [original-result__41914__auto__
    (tech.v3.datatype.functional/bit-test x y)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__41914__auto__)))
 ([x y & args]
  (let
   [original-result__41914__auto__
    (clojure.core/apply tech.v3.datatype.functional/bit-test x y args)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__41914__auto__))))
