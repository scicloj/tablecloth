...
(defn
 ...
 ([x]
  (let
   [original-result__59970__auto__
...
(defn
 ...
 ([x y]
  (let
   [original-result__59971__auto__
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/log x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
...
(defn
 ...
 ([x y]
  (let
   [original-result__59970__auto__ (tech.v3.datatype.functional/< x y)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59970__auto__)))
 ([x y z]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/sq x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__59970__auto__ (tech.v3.datatype.functional/sum x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59970__auto__)))
 ([x options]
  (let
...
(defn
 ...
 ([rdr n]
  (let
   [original-result__59971__auto__
    (tech.v3.datatype.functional/shift rdr n)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
 ...
 *
 ...
 ([x y]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/* x y)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__)))
 ([x y & args]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/min x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/cos x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/tan x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/exp x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__59970__auto__ (tech.v3.datatype.functional/not x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59970__auto__)))
 ([x options]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/abs x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/max x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/ulp x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__59971__auto__ (tech.v3.datatype.functional/sin x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__59971__auto__))))
