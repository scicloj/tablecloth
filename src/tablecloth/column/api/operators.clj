...
(defn
 ...
 ([col]
  (let
   [original-result__34677__auto__
...
(defn
 ...
 ([lhs mid rhs]
  (let
   [original-result__34678__auto__
...
(defn
 ...
 ([x]
  (let
   [original-result__34678__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__34678__auto__)))
 ([x y]
  (let
   [original-result__34678__auto__ (tech.v3.datatype.functional/- x y)]
   (tablecloth.column.api.utils/return-scalar-or-column
    original-result__34678__auto__)))
 ([x y & args]
  (let
