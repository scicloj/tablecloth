...
(defn
 ...
 ([x options]
  (let
   [original-result__42152__auto__
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/log x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x y]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/< x y)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/sq x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/sum x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/min x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/cos x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/tan x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/exp x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/not x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42151__auto__
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/abs x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/max x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/ulp x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__42152__auto__ (tech.v3.datatype.functional/sin x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__42152__auto__))))
