...
(defn
 ...
 ([x options]
  (let
   [original-result__33001__auto__
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-set x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-shift-right x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/ieee-remainder x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/log x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-shift-left x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/< x y)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/atan2 x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/hypot x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/sq x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/sum x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-xor x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
 ...
 *
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/* x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/min x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x y]
  (let
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/min x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/cumprod x options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x]
  (let
...
(defn
 ...
 ([x options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/cumsum x options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x]
  (let
...
(defn
 ...
 ([x stats-names]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/descriptive-statistics x stats-names)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x]
  (let
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-and-not x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/cos x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/quot x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/tan x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/spearmans-correlation x y options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/- x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/pow x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/exp x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/rem x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-and x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/kendalls-correlation x y options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/not x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/cummin x options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x]
  (let
...
(defn
 ...
 ([x options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/cummax x options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x]
  (let
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-or x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/equals x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-flip x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/quartiles x options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/bit-clear x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/abs x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x y options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/pearsons-correlation x y options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x y]
  (let
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/max x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x y]
  (let
 ...
 ([x y & args]
  (let
   [original-result__33001__auto__
    (apply tech.v3.datatype.functional/max x y args)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/ulp x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x percentages options]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/percentiles x percentages options)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__)))
 ([x percentages]
  (let
   [original-result__33001__auto__
    (tech.v3.datatype.functional/percentiles x percentages)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
...
(defn
 ...
 ([x]
  (let
   [original-result__33001__auto__ (tech.v3.datatype.functional/sin x)]
   (tablecloth.column.api.lift-operators/return-scalar-or-column
    original-result__33001__auto__))))
