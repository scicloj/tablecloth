...
(defn
 ...
 ([ds columns-selector options]
  (let
   [aggregator__31450__auto__
    (clojure.core/fn
     [ds__31451__auto__]
     (let
      [ds-with-selected-cols__31452__auto__
       (tablecloth.api/select-columns
        ds__31451__auto__
        columns-selector)
       cols-count__31453__auto__
       (clojure.core/->
        ds-with-selected-cols__31452__auto__
        tablecloth.api/column-names
        clojure.core/count)
       selected-cols__31454__auto__
       (tablecloth.api/columns ds-with-selected-cols__31452__auto__)]
      (if
       (clojure.core/>= 1 cols-count__31453__auto__)
       (clojure.core/apply
   ...
   (tablecloth.api/aggregate ds aggregator__31450__auto__)))
 ([ds columns-selector]
  (let
   [aggregator__31450__auto__
    (clojure.core/fn
...
(defn
 ...
 ([ds target-col columns-selector]
  (let
   [selected-cols__31455__auto__
    (clojure.core/apply
     clojure.core/vector
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__31456__auto__
    (clojure.core/concat selected-cols__31455__auto__ [])]
   (if
    (clojure.core/>=
     ##Inf
     (clojure.core/count selected-cols__31455__auto__))
    (clojure.core/->>
     args-to-pass__31456__auto__
   ...
   [selected-cols__31455__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__31456__auto__
    (clojure.core/concat selected-cols__31455__auto__ [options])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__31455__auto__))
    ...
    (clojure.core/fn
     ...
     (let
      [ds-with-selected-cols__31452__auto__
       ...
       (tablecloth.api/columns ds-with-selected-cols__31452__auto__)]
      (if
       (clojure.core/>= 2 cols-count__31453__auto__)
       (clojure.core/apply
   ...
   [selected-cols__31455__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__31456__auto__
    (clojure.core/concat selected-cols__31455__auto__ [n])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__31455__auto__))
   ...
   [selected-cols__31455__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__31456__auto__
    (clojure.core/concat selected-cols__31455__auto__ [percentages])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__31455__auto__))
