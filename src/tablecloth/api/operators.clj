...
(defn
 ...
 ([ds target-col columns-selector]
  (let
   [selected-cols__33796__auto__
    (clojure.core/apply
     clojure.core/vector
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__33797__auto__
    (clojure.core/concat selected-cols__33796__auto__ [])]
   (if
    (clojure.core/>=
     ##Inf
     (clojure.core/count selected-cols__33796__auto__))
    (clojure.core/->>
     args-to-pass__33797__auto__
   ...
   [selected-cols__33796__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__33797__auto__
    (clojure.core/concat selected-cols__33796__auto__ [options])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__33796__auto__))
   ...
   [selected-cols__33796__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__33797__auto__
    (clojure.core/concat selected-cols__33796__auto__ [max-span])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__33796__auto__))
   ...
   [selected-cols__33796__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__33797__auto__
    (clojure.core/concat selected-cols__33796__auto__ [n])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__33796__auto__))
   ...
   [selected-cols__33796__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api/select-columns ds columns-selector)))
    args-to-pass__33797__auto__
    (clojure.core/concat selected-cols__33796__auto__ [percentiles])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__33796__auto__))
