...
(defn
 ...
 ([ds columns-selector options]
  (let
   [aggregator__29788__auto__
    (clojure.core/fn
     [ds__29789__auto__]
     (let
      [ds-with-selected-cols__29790__auto__
       (tablecloth.api.columns/select-columns
        ds__29789__auto__
        columns-selector)
       cols-count__29791__auto__
       (clojure.core/->
        ds-with-selected-cols__29790__auto__
        tablecloth.api.utils/column-names
        clojure.core/count)
       selected-cols__29792__auto__
       (tablecloth.api.dataset/columns
        ds-with-selected-cols__29790__auto__)]
      (if
       (clojure.core/>= 1 cols-count__29791__auto__)
       (clojure.core/apply
   ...
   (tablecloth.api.aggregate/aggregate ds aggregator__29788__auto__)))
 ([ds columns-selector]
  (let
   [aggregator__29788__auto__
    (clojure.core/fn
...
(defn
 ...
 ([ds target-col columns-selector]
  (let
   [selected-cols__29793__auto__
    (clojure.core/apply
     clojure.core/vector
     (tablecloth.api.dataset/columns
      (tablecloth.api.columns/select-columns ds columns-selector)))
    args-to-pass__29794__auto__
    (clojure.core/concat selected-cols__29793__auto__ [])]
   (if
    (clojure.core/>=
     ##Inf
     (clojure.core/count selected-cols__29793__auto__))
    (clojure.core/->>
     args-to-pass__29794__auto__
   ...
   [selected-cols__29793__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api.columns/select-columns ds columns-selector)))
    args-to-pass__29794__auto__
    (clojure.core/concat selected-cols__29793__auto__ [options])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__29793__auto__))
     ...
     (let
      [ds-with-selected-cols__29790__auto__
       ...
       (tablecloth.api.dataset/columns
        ds-with-selected-cols__29790__auto__)]
      (if
       (clojure.core/>= 2 cols-count__29791__auto__)
       (clojure.core/apply
   ...
   [selected-cols__29793__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api.columns/select-columns ds columns-selector)))
    args-to-pass__29794__auto__
    (clojure.core/concat selected-cols__29793__auto__ [n])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__29793__auto__))
   ...
   [selected-cols__29793__auto__
    (clojure.core/apply
     ...
     (tablecloth.api.dataset/columns
      (tablecloth.api.columns/select-columns ds columns-selector)))
    args-to-pass__29794__auto__
    (clojure.core/concat selected-cols__29793__auto__ [percentages])]
   (if
    (clojure.core/>=
     1
     (clojure.core/count selected-cols__29793__auto__))
