...
### Relevant files
- [notebooks/draft.clj](notebooks/index.clj) - the tutorial as a Kindly notebook (developed with Clay)
...
- [docs/draft.html](docs/index.html) - the tutorial rendered using Clay and [Quarto](https://quarto.org/)
