...
\begin{verbatim}
([#object[java.time.LocalDate 0x7a6119ad "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x60cb912 "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
\end{verbatim}
...
\begin{verbatim}
({"date" #object[java.time.LocalDate 0x3d83dac0 "2012-01-01"],
  "precipitation" 0.0,
  "temp_min" 5.0,
  "weather" "drizzle",
  "temp_max" 12.8,
  "wind" 4.7}
 {"date" #object[java.time.LocalDate 0x59d18e9b "2012-01-02"],
  "precipitation" 10.9,
  "temp_min" 2.8,
  "weather" "rain",
  "temp_max" 10.6,
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@31b4acd}{\nolinkurl{java.lang.Object@31b4acd}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5 & A\tabularnewline
2 & 2 & 1.0 & B\tabularnewline
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@59379aac}{\nolinkurl{java.lang.Object@59379aac}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5 & A\tabularnewline
1 & 3 & 1.5 & C\tabularnewline
...
\midrule
\endhead
0.3536 & 1 & 0.5 & A\tabularnewline
0.6355 & 2 & 1.0 & B\tabularnewline
0.6526 & 3 & 1.5 & C\tabularnewline
0.03654 & 4 & 0.5 & A\tabularnewline
0.8429 & 5 & 1.0 & B\tabularnewline
0.6414 & 6 & 1.5 & C\tabularnewline
0.5979 & 7 & 0.5 & A\tabularnewline
0.6496 & 8 & 1.0 & B\tabularnewline
0.08426 & 9 & 1.5 & C\tabularnewline
\bottomrule
\end{longtable}
...
\begin{verbatim}
#object["[J" 0x4927995f "[J@4927995f"]
\end{verbatim}
...
\begin{verbatim}
(#object["[J" 0x5a6c3b16 "[J@5a6c3b16"] #object["[J" 0x79d8b344 "[J@79d8b344"] #object["[J" 0x7064057d "[J@7064057d"])
\end{verbatim}
...
\begin{verbatim}
#object["[Ljava.lang.String;" 0x38053993 "[Ljava.lang.String;@38053993"]
#object["[F" 0x2301b48e "[F@2301b48e"]
\end{verbatim}
...
\item
  ...
  \item
    ...
    (default: \texttt{true}). When set to \texttt{:all} keeps only
    separation result.
  \item
...
\NormalTok{                                  \{}\AttributeTok{:int-part}\NormalTok{ (}\KeywordTok{int}\NormalTok{ (}\KeywordTok{quot}\NormalTok{ v }\FloatTok{1.0}\NormalTok{))}
                                   \AttributeTok{:fract-part}\NormalTok{ (}\KeywordTok{mod}\NormalTok{ v }\FloatTok{1.0}\NormalTok{)\}) \{}\AttributeTok{:drop-column}\NormalTok{? }\AttributeTok{:all}\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
\midrule
\endhead
1 & 1 & 0 & 0.59645329 & 0.61545947 & 3 & -2\tabularnewline
2 & 1 & 1 & 0.71754831 & 0.31569899 & 3 & -2\tabularnewline
3 & 0 & 1 & 0.60349209 & 0.02343240 & 3 & -2\tabularnewline
4 & 0 & 1 & 0.37613933 & 0.52658520 & 3 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
1 & 1 & 0 & 1 & 0.59645329 & 3\tabularnewline
2 & 1 & 1 & 1 & 0.71754831 & 3\tabularnewline
3 & 0 & 1 & 1 & 0.60349209 & 3\tabularnewline
4 & 0 & 1 & 1 & 0.37613933 & 3\tabularnewline
1 & 1 & 0 & 2 & 0.61545947 & -2\tabularnewline
2 & 1 & 1 & 2 & 0.31569899 & -2\tabularnewline
3 & 0 & 1 & 2 & 0.02343240 & -2\tabularnewline
4 & 0 & 1 & 2 & 0.52658520 & -2\tabularnewline
\bottomrule
\end{longtable}
