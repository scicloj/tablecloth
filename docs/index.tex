...
\begin{verbatim}
([#object[java.time.LocalDate 0x1e6e4081 "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x4802434 "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
\end{verbatim}
...
\begin{verbatim}
({"date" #object[java.time.LocalDate 0x77bdf4d8 "2012-01-01"],
  "precipitation" 0.0,
  "temp_min" 5.0,
  "weather" "drizzle",
  "temp_max" 12.8,
  "wind" 4.7}
 {"date" #object[java.time.LocalDate 0x1fefd789 "2012-01-02"],
  "precipitation" 10.9,
  "temp_min" 2.8,
  "weather" "rain",
  "temp_max" 10.6,
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@6b104ab4}{\nolinkurl{java.lang.Object@6b104ab4}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5 & A\tabularnewline
2 & 2 & 1.0 & B\tabularnewline
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@59825c7b}{\nolinkurl{java.lang.Object@59825c7b}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5 & A\tabularnewline
1 & 3 & 1.5 & C\tabularnewline
...
\midrule
\endhead
0.3585 & 1 & 0.5 & A\tabularnewline
0.2696 & 2 & 1.0 & B\tabularnewline
0.1241 & 3 & 1.5 & C\tabularnewline
0.7789 & 4 & 0.5 & A\tabularnewline
0.7024 & 5 & 1.0 & B\tabularnewline
0.9305 & 6 & 1.5 & C\tabularnewline
0.8839 & 7 & 0.5 & A\tabularnewline
0.9883 & 8 & 1.0 & B\tabularnewline
0.6800 & 9 & 1.5 & C\tabularnewline
\bottomrule
\end{longtable}
...
\begin{verbatim}
#object["[J" 0x6d96e1ca "[J@6d96e1ca"]
\end{verbatim}
...
\begin{verbatim}
(#object["[J" 0x51677250 "[J@51677250"] #object["[J" 0x4079c46e "[J@4079c46e"] #object["[J" 0x50628a22 "[J@50628a22"])
\end{verbatim}
...
\begin{verbatim}
#object["[Ljava.lang.String;" 0x4848cbe7 "[Ljava.lang.String;@4848cbe7"]
#object["[F" 0x534c414c "[F@534c414c"]
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{->}\NormalTok{ (api/dataset \{}\AttributeTok{:dt}\NormalTok{ [(java.}\KeywordTok{time}\NormalTok{.LocalDateTime/of }\DecValTok{2020} \DecValTok{01} \DecValTok{01} \DecValTok{11} \DecValTok{22} \DecValTok{33}\NormalTok{)}
                       \VariableTok{nil} \VariableTok{nil} \VariableTok{nil} \VariableTok{nil} \VariableTok{nil} \VariableTok{nil} \VariableTok{nil}
\NormalTok{                       (java.}\KeywordTok{time}\NormalTok{.LocalDateTime/of }\DecValTok{2020} \DecValTok{10} \DecValTok{01} \DecValTok{01} \DecValTok{01} \DecValTok{01}\NormalTok{)]\})}
...
\midrule
\endhead
1 & 1 & 0 & 0.87744684 & 0.47447710 & 3 & -2\tabularnewline
2 & 1 & 1 & 0.07597678 & 0.74594409 & 3 & -2\tabularnewline
3 & 0 & 1 & 0.77728845 & 0.64364140 & 3 & -2\tabularnewline
4 & 0 & 1 & 0.31083780 & 0.88360303 & 3 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
1 & 1 & 0 & 1 & 0.87744684 & 3\tabularnewline
2 & 1 & 1 & 1 & 0.07597678 & 3\tabularnewline
3 & 0 & 1 & 1 & 0.77728845 & 3\tabularnewline
4 & 0 & 1 & 1 & 0.31083780 & 3\tabularnewline
1 & 1 & 0 & 2 & 0.47447710 & -2\tabularnewline
2 & 1 & 1 & 2 & 0.74594409 & -2\tabularnewline
3 & 0 & 1 & 2 & 0.64364140 & -2\tabularnewline
4 & 0 & 1 & 2 & 0.88360303 & -2\tabularnewline
\bottomrule
\end{longtable}
