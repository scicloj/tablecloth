...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Dataset manipulation API for tech.ml.dataset library},
...
\texttt{api/write!}. Function accepts:
...
\begin{verbatim}
([#object[java.time.LocalDate 0x51425298 "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x5f9c876 "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
\end{verbatim}
...
\begin{verbatim}
({"date" #object[java.time.LocalDate 0x77ac2316 "2012-01-01"],
  "precipitation" 0.0,
  "temp_min" 5.0,
  "weather" "drizzle",
  "temp_max" 12.8,
  "wind" 4.7}
 {"date" #object[java.time.LocalDate 0x724e4a05 "2012-01-02"],
  "precipitation" 10.9,
  "temp_min" 2.8,
  "weather" "rain",
  "temp_max" 10.6,
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(api/select-columns DS }\AttributeTok{:type/float64}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(api/drop-columns DS }\AttributeTok{:type/float64}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@4a2418a3}{\nolinkurl{java.lang.Object@4a2418a3}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5 & A\tabularnewline
2 & 2 & 1.0 & B\tabularnewline
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@416103e}{\nolinkurl{java.lang.Object@416103e}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5 & A\tabularnewline
1 & 3 & 1.5 & C\tabularnewline
...
\midrule
\endhead
0.6279 & 1 & 0.5 & A\tabularnewline
0.3538 & 2 & 1.0 & B\tabularnewline
0.2101 & 3 & 1.5 & C\tabularnewline
0.8933 & 4 & 0.5 & A\tabularnewline
0.5776 & 5 & 1.0 & B\tabularnewline
0.5691 & 6 & 1.5 & C\tabularnewline
0.4687 & 7 & 0.5 & A\tabularnewline
0.1408 & 8 & 1.0 & B\tabularnewline
0.9444 & 9 & 1.5 & C\tabularnewline
\bottomrule
\end{longtable}
...
2 & 3 & 1.5 & C\tabularnewline
1 & 5 & 0.5 & A\tabularnewline
2 & 1 & 1.0 & B\tabularnewline
...
\begin{longtable}[]{@{}llll@{}}
\toprule
:V4 & :V3 & :V2 & :V1\tabularnewline
\midrule
\endhead
A & 0.5 & 1 & 1\tabularnewline
B & 1.0 & 2 & 2\tabularnewline
C & 1.5 & 3 & 1\tabularnewline
A & 0.5 & 4 & 2\tabularnewline
B & 1.0 & 5 & 1\tabularnewline
C & 1.5 & 6 & 2\tabularnewline
A & 0.5 & 7 & 1\tabularnewline
B & 1.0 & 8 & 2\tabularnewline
C & 1.5 & 9 & 1\tabularnewline
\bottomrule
\end{longtable}
...
\begin{verbatim}
#object["[J" 0x5517e139 "[J@5517e139"]
\end{verbatim}
...
\begin{verbatim}
(#object["[J" 0x37361bc1 "[J@37361bc1"] #object["[J" 0x2ec50f5c "[J@2ec50f5c"] #object["[J" 0x21612fea "[J@21612fea"])
\end{verbatim}
...
\begin{verbatim}
#object["[Ljava.lang.String;" 0x7aee9c39 "[Ljava.lang.String;@7aee9c39"]
#object["[F" 0x61ea5554 "[F@61ea5554"]
\end{verbatim}
...
\NormalTok{                     \{}\AttributeTok{:pre}\NormalTok{ \{}\AttributeTok{:mean}\NormalTok{ #(tech.v3.datatype.functional/mean (}\VariableTok{%} \AttributeTok{:V2}\NormalTok{))\}\})}
\NormalTok{    (api/ungroup))}
\end{Highlighting}
\end{Shaded}
...
\item
  strategy, default: \texttt{:nearest}
\item
  value (optional)
...
\item
  ...
  the beginning
\item
  \texttt{:mid} or \texttt{:nearest} - copy values around known values
\item
  \texttt{:midpoint} - use average value from previous and next
  non-missing
\item
  \texttt{:lerp} - trying to lineary approximate values, works for
  numbers and datetime, otherwise applies \texttt{:nearest}. For numbers
  always results in \texttt{float} datatype.
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(api/replace-missing DSm2 [}\AttributeTok{:a} \AttributeTok{:b}\NormalTok{] }\AttributeTok{:midpoint}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
1.0 & 2.0\tabularnewline
1.0 & 2.0\tabularnewline
1.0 & 7.5\tabularnewline
2.0 & 7.5\tabularnewline
3.0 & 7.5\tabularnewline
3.0 & 7.5\tabularnewline
3.0 & 7.5\tabularnewline
3.0 & 7.5\tabularnewline
3.0 & 13.0\tabularnewline
4.0 & 8.0\tabularnewline
7.5 & 3.0\tabularnewline
...
\midrule
\endhead
1.00000000 & 2.00000000\tabularnewline
1.00000000 & 2.00000000\tabularnewline
1.00000000 & 2.00000000\tabularnewline
1.00000000 & 3.57142857\tabularnewline
2.00000000 & 5.14285714\tabularnewline
2.33333333 & 6.71428571\tabularnewline
2.66666667 & 8.28571429\tabularnewline
3.00000000 & 9.85714286\tabularnewline
3.33333333 & 11.42857143\tabularnewline
3.66666667 & 13.00000000\tabularnewline
4.00000000 & 8.00000000\tabularnewline
7.50000000 & 3.00000000\tabularnewline
11.00000000 & 4.00000000\tabularnewline
11.00000000 & 5.00000000\tabularnewline
11.00000000 & 5.00000000\tabularnewline
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}lllll@{}}
\toprule
:V1 & :indexes & :V4 & :V2 & :V3\tabularnewline
\midrule
\endhead
1 & 0 & A & 1 & 0.5000\tabularnewline
1 & 1 & C & 3 & 1.500\tabularnewline
1 & 2 & B & 5 & 1.000\tabularnewline
1 & 3 & A & 7 & 0.5000\tabularnewline
1 & 4 & C & 9 & 1.500\tabularnewline
2 & 0 & B & 2 & 1.000\tabularnewline
2 & 1 & A & 4 & 0.5000\tabularnewline
2 & 2 & C & 6 & 1.500\tabularnewline
2 & 3 & B & 8 & 1.000\tabularnewline
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}lllll@{}}
\toprule
:V1 & vector idx & :V4 & :V2 & :V3\tabularnewline
\midrule
\endhead
1 & 0 & A & 1 & 0.5000\tabularnewline
1 & 1 & C & 3 & 1.500\tabularnewline
...
\midrule
\endhead
1 & 1 & 0 & 0.13417381 & 0.22293720 & 3 & -2\tabularnewline
2 & 1 & 1 & 0.49675912 & 0.98428494 & 3 & -2\tabularnewline
3 & 0 & 1 & 0.72803790 & 0.26411232 & 3 & -2\tabularnewline
4 & 0 & 1 & 0.99837273 & 0.80129411 & 3 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
1 & 1 & 0 & 1 & 0.13417381 & 3\tabularnewline
2 & 1 & 1 & 1 & 0.49675912 & 3\tabularnewline
3 & 0 & 1 & 1 & 0.72803790 & 3\tabularnewline
4 & 0 & 1 & 1 & 0.99837273 & 3\tabularnewline
1 & 1 & 0 & 2 & 0.22293720 & -2\tabularnewline
2 & 1 & 1 & 2 & 0.98428494 & -2\tabularnewline
3 & 0 & 1 & 2 & 0.26411232 & -2\tabularnewline
4 & 0 & 1 & 2 & 0.80129411 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\texttt{concat-copying} ensures all readers are evaluated.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(api/concat-copying ds1)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{split-into-traintest}{%
\subsubsection{Split into train/test}\label{split-into-traintest}}

In ML world very often you need to test given model and prepare
collection of train and test datasets. \texttt{split} creates a lazy
sequence of maps containing splitted dataset. Map contains two datasets
under \texttt{:train} and \texttt{:test} keys.

\texttt{split-type} can be one of the following:

\begin{itemize}
\tightlist
\item
  \texttt{:kfold} (default) - k-fold strategy, \texttt{:k} defines
  number of folds (defaults to \texttt{5}), produces \texttt{k} splits
\item
  \texttt{:bootstrap} - \texttt{:ratio} defines ratio of observations
  put into result (defaults to \texttt{1.0}), produces \texttt{1} split
\item
  \texttt{:holdout} - split into two parts with given ratio (defaults to
  \texttt{2/3}), produces \texttt{1} split
\item
  \texttt{:loo} - leave one out, produces the same number of splits as
...
\tightlist
\item
  \texttt{:seed} - for random number generator
\item
  \texttt{:repeats} - repeat procedure \texttt{:repeats} times
\item
  \texttt{:partition-selector} - same as in \texttt{group-by} for
  stratified splitting to reflect dataset structure in splits.
\end{itemize}
...
See
\href{https://www.mitpressjournals.org/doi/pdf/10.1162/EVCO_a_00069}{more}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\BuiltInTok{def}\FunctionTok{ for-splitting }\NormalTok{(api/dataset (map-indexed (}\KeywordTok{fn}\NormalTok{ [id v] \{}\AttributeTok{:id}\NormalTok{ id}
                                                        \AttributeTok{:partition}\NormalTok{ v}
                                                        \AttributeTok{:group}\NormalTok{ (}\KeywordTok{rand-nth}\NormalTok{ [}\AttributeTok{:g1} \AttributeTok{:g2} \AttributeTok{:g3}\NormalTok{])\})}
\NormalTok{                                             (}\KeywordTok{concat}\NormalTok{ (}\KeywordTok{repeat} \DecValTok{20} \AttributeTok{:a}\NormalTok{) (}\KeywordTok{repeat} \DecValTok{5} \AttributeTok{:b}\NormalTok{)))))}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{for-splitting}
\end{Highlighting}
\end{Shaded}
...
\begin{longtable}[]{@{}lll@{}}
\toprule
:id & :partition & :group\tabularnewline
\midrule
\endhead
0 & :a & :g3\tabularnewline
1 & :a & :g3\tabularnewline
2 & :a & :g3\tabularnewline
3 & :a & :g3\tabularnewline
4 & :a & :g3\tabularnewline
5 & :a & :g2\tabularnewline
6 & :a & :g2\tabularnewline
7 & :a & :g1\tabularnewline
8 & :a & :g1\tabularnewline
9 & :a & :g1\tabularnewline
10 & :a & :g2\tabularnewline
11 & :a & :g2\tabularnewline
12 & :a & :g2\tabularnewline
13 & :a & :g2\tabularnewline
14 & :a & :g2\tabularnewline
15 & :a & :g3\tabularnewline
16 & :a & :g2\tabularnewline
17 & :a & :g1\tabularnewline
18 & :a & :g3\tabularnewline
19 & :a & :g1\tabularnewline
20 & :b & :g2\tabularnewline
21 & :b & :g3\tabularnewline
22 & :b & :g1\tabularnewline
23 & :b & :g2\tabularnewline
24 & :b & :g3\tabularnewline
\bottomrule
\end{longtable}
...
Returns \texttt{k=5} maps

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{first}\NormalTok{ (api/split for-splitting))}
\end{Highlighting}
\end{Shaded}
...
Partition according to \texttt{:k} column to reflect it's distribution

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{first}\NormalTok{ (api/split for-splitting }\AttributeTok{:kfold}\NormalTok{ \{}\AttributeTok{:partition-selector} \AttributeTok{:partition}\NormalTok{\}))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(api/split for-splitting }\AttributeTok{:bootstrap}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{count}\NormalTok{ (api/split for-splitting }\AttributeTok{:bootstrap}\NormalTok{ \{}\AttributeTok{:repeats} \DecValTok{100}\NormalTok{\}))}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{holdout}{%
\paragraph{Holdout}\label{holdout}}

with small ratio

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(api/split for-splitting }\AttributeTok{:holdout}\NormalTok{ \{}\AttributeTok{:ratio} \FloatTok{0.2}\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{count}\NormalTok{ (api/split for-splitting }\AttributeTok{:loo}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{first}\NormalTok{ (api/split for-splitting }\AttributeTok{:loo}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{grouped-dataset-with-partitioning}{%
\paragraph{Grouped dataset with
partitioning}\label{grouped-dataset-with-partitioning}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{first}\NormalTok{ (}\KeywordTok{->}\NormalTok{ for-splitting}
\NormalTok{           (api/group-by }\AttributeTok{:group}\NormalTok{)}
\NormalTok{           (api/split }\AttributeTok{:bootstrap}\NormalTok{ \{}\AttributeTok{:partition-selector} \AttributeTok{:partition} \AttributeTok{:seed} \DecValTok{11} \AttributeTok{:ratio} \FloatTok{0.8}\NormalTok{\})))}
\end{Highlighting}
\end{Shaded}
...
\midrule
\endhead
:g1 & 0 & Train set, Group: :g1 {[}5 3{]}:\tabularnewline
:g2 & 1 & Train set, Group: :g2 {[}9 3{]}:\tabularnewline
:g3 & 2 & Train set, Group: :g3 {[}8 3{]}:\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
:g1 & 0 & Test set, Group: :g1 {[}2 3{]}:\tabularnewline
:g2 & 1 & Test set, Group: :g2 {[}4 3{]}:\tabularnewline
:g3 & 2 & Test set, Group: :g3 {[}3 3{]}:\tabularnewline
\bottomrule
\end{longtable}
...
\NormalTok{                    \{}\AttributeTok{:symbol}\NormalTok{ (}\AttributeTok{:symbol}\NormalTok{ row)}
                     \AttributeTok{:year}\NormalTok{ (tech.v3.datatype.datetime/long-temporal-field }\AttributeTok{:years}\NormalTok{ (}\AttributeTok{:date}\NormalTok{ row))\}))}
\NormalTok{    (api/aggregate #(tech.v3.datatype.functional/mean (}\VariableTok{%} \AttributeTok{:price}\NormalTok{)))}
...
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{->}\NormalTok{ stocks}
\NormalTok{    (api/group-by (}\KeywordTok{juxt} \AttributeTok{:symbol}\NormalTok{ #(tech.v3.datatype.datetime/long-temporal-field }\AttributeTok{:years}\NormalTok{ (}\VariableTok{%} \AttributeTok{:date}\NormalTok{))))}
\NormalTok{    (api/aggregate #(tech.v3.datatype.functional/mean (}\VariableTok{%} \AttributeTok{:price}\NormalTok{)))}
...
\NormalTok{     (aops/argfilter #(}\KeywordTok{<} \VariableTok{%} \FloatTok{0.0}\NormalTok{))}
...
\begin{longtable}[]{@{}lllll@{}}
\toprule
month & origin & dest & arr\_delay & dep\_delay\tabularnewline
\midrule
\endhead
9 & LGA & DFW & -8.78772379 & -0.25575448\tabularnewline
10 & LGA & DFW & 3.50000000 & 4.55276382\tabularnewline
...
\NormalTok{    (api/update-columns [}\StringTok{"true"} \StringTok{"false"}\NormalTok{] (}\KeywordTok{partial} \KeywordTok{map}\NormalTok{ #(}\KeywordTok{if}\NormalTok{ (}\KeywordTok{sequential?} \VariableTok{%}\NormalTok{) (}\KeywordTok{count} \VariableTok{%}\NormalTok{) }\DecValTok{1}\NormalTok{))))}
\end{Highlighting}
\end{Shaded}
