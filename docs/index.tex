...
\begin{verbatim}
([#object[java.time.LocalDate 0x4ce974eb "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x51a7eb8 "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
\end{verbatim}
...
\begin{verbatim}
({"date" #object[java.time.LocalDate 0x2289f7fd "2012-01-01"],
  "precipitation" 0.0,
  "temp_min" 5.0,
  "weather" "drizzle",
  "temp_max" 12.8,
  "wind" 4.7}
 {"date" #object[java.time.LocalDate 0x7b2cc257 "2012-01-02"],
  "precipitation" 10.9,
  "temp_min" 2.8,
  "weather" "rain",
  "temp_max" 10.6,
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@6330870a}{\nolinkurl{java.lang.Object@6330870a}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5 & A\tabularnewline
2 & 2 & 1.0 & B\tabularnewline
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@73403ed4}{\nolinkurl{java.lang.Object@73403ed4}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5 & A\tabularnewline
1 & 3 & 1.5 & C\tabularnewline
...
\midrule
\endhead
0.9133 & 1 & 0.5 & A\tabularnewline
0.6750 & 2 & 1.0 & B\tabularnewline
0.4417 & 3 & 1.5 & C\tabularnewline
0.4905 & 4 & 0.5 & A\tabularnewline
0.5630 & 5 & 1.0 & B\tabularnewline
0.4868 & 6 & 1.5 & C\tabularnewline
0.05380 & 7 & 0.5 & A\tabularnewline
0.2288 & 8 & 1.0 & B\tabularnewline
0.4383 & 9 & 1.5 & C\tabularnewline
\bottomrule
\end{longtable}
...
1 & 9 & 1.5 & C\tabularnewline
2 & 1 & 0.5 & A\tabularnewline
1 & 8 & 1.0 & B\tabularnewline
2 & 5 & 1.5 & C\tabularnewline
...
\begin{verbatim}
#object["[J" 0x2fbc4cc5 "[J@2fbc4cc5"]
\end{verbatim}
...
\begin{verbatim}
(#object["[J" 0x3da4c3c "[J@3da4c3c"] #object["[J" 0x71e39fa2 "[J@71e39fa2"] #object["[J" 0x532b03cd "[J@532b03cd"])
\end{verbatim}
...
\begin{verbatim}
#object["[Ljava.lang.String;" 0x3a2dc1b5 "[Ljava.lang.String;@3a2dc1b5"]
#object["[F" 0x21296e78 "[F@21296e78"]
\end{verbatim}
...
\midrule
\endhead
1 & 1 & 0 & 0.95463349 & 0.62896999 & 3 & -2\tabularnewline
2 & 1 & 1 & 0.35672421 & 0.25037243 & 3 & -2\tabularnewline
3 & 0 & 1 & 0.75625715 & 0.27538392 & 3 & -2\tabularnewline
4 & 0 & 1 & 0.44958768 & 0.53797373 & 3 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
1 & 1 & 0 & 1 & 0.95463349 & 3\tabularnewline
2 & 1 & 1 & 1 & 0.35672421 & 3\tabularnewline
3 & 0 & 1 & 1 & 0.75625715 & 3\tabularnewline
4 & 0 & 1 & 1 & 0.44958768 & 3\tabularnewline
1 & 1 & 0 & 2 & 0.62896999 & -2\tabularnewline
2 & 1 & 1 & 2 & 0.25037243 & -2\tabularnewline
3 & 0 & 1 & 2 & 0.27538392 & -2\tabularnewline
4 & 0 & 1 & 2 & 0.53797373 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{comment}\NormalTok{ (api/pivot->wider stocks-long }\AttributeTok{:stocks} \AttributeTok{:price}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{comment}\NormalTok{ (api/write-csv! DS }\StringTok{"DF.txt"}\NormalTok{ \{}\AttributeTok{:separator} \CharTok{\textbackslash{}tab}\NormalTok{\}))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\KeywordTok{comment}\NormalTok{ (api/dataset }\StringTok{"DF.txt"}\NormalTok{ \{}\AttributeTok{:key-fn} \KeywordTok{keyword}\NormalTok{\}))}
\end{Highlighting}
\end{Shaded}
