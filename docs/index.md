...
```
    ...
    ([#object[java.time.LocalDate 0x6bca3ef0 "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x7b2e91fa "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
...
```
    ...
    #object["[[D" 0x6ca5ebaa "[[D@6ca5ebaa"]
...
```
    ...
    #object["[[D" 0x36440c31 "[[D@36440c31"]
...
```
    ...
    ({"date" #object[java.time.LocalDate 0x325ee8da "2012-01-01"],
      "precipitation" 0.0,
      "temp_min" 5.0,
      "weather" "drizzle",
      "temp_max" 12.8,
      "wind" 4.7}
     {"date" #object[java.time.LocalDate 0x35d553dc "2012-01-02"],
      "precipitation" 10.9,
      "temp_min" 2.8,
      "weather" "rain",
      "temp_max" 10.6,
...
| v1 | v2 | \[1 2 3\] | <java.lang.Object@34b8362> |
| -- | -- | --------- | -------------------------- |
| 1  | 1  | 0.5       | A                          |
| 2  | 2  | 1.0       | B                          |
| 1  | 3  | 1.5       | C                          |
...
| v1 | v2 | \[1 2 3\] | <java.lang.Object@484ae035> |
| -- | -- | --------- | --------------------------- |
| 1  | 1  | 0.5       | A                           |
| 1  | 3  | 1.5       | C                           |
| 1  | 5  | 1.0       | B                           |
...
```
    ...
    #object["[J" 0x38966415 "[J@38966415"]
...
```
    ...
    (#object["[J" 0x6180c708 "[J@6180c708"] #object["[J" 0x323fd0c4 "[J@323fd0c4"] #object["[J" 0x3e25dc1b "[J@3e25dc1b"])
...
```
    ...
    #object["[Ljava.lang.String;" 0x4852ce39 "[Ljava.lang.String;@4852ce39"]
    #object["[F" 0x5356e3e2 "[F@5356e3e2"]
...
| :x | :a | :b | :y1        | :y2        | :z1 | :z2 |
| -- | -- | -- | ---------- | ---------- | --- | --- |
| 1  | 1  | 0  | 0.10155415 | 0.15034903 | 3   | \-2 |
| 2  | 1  | 1  | 0.43933091 | 0.10493629 | 3   | \-2 |
| 3  | 0  | 1  | 0.65924223 | 0.30963202 | 3   | \-2 |
| 4  | 0  | 1  | 0.60379172 | 0.14238893 | 3   | \-2 |
...
| :x | :a | :b | :times | y          | z   |
| -- | -- | -- | ------ | ---------- | --- |
| 1  | 1  | 0  | 1      | 0.10155415 | 3   |
| 2  | 1  | 1  | 1      | 0.43933091 | 3   |
| 3  | 0  | 1  | 1      | 0.65924223 | 3   |
| 4  | 0  | 1  | 1      | 0.60379172 | 3   |
| 1  | 1  | 0  | 2      | 0.15034903 | \-2 |
| 2  | 1  | 1  | 2      | 0.10493629 | \-2 |
| 3  | 0  | 1  | 2      | 0.30963202 | \-2 |
| 4  | 0  | 1  | 2      | 0.14238893 | \-2 |
...
| :name                                  | :group-id | :data                                                   |
| -------------------------------------- | --------- | ------------------------------------------------------- |
| {:\(split-name :train, :\)split-id 0}  | 0         | Group: {:\(split-name :train, :\)split-id 0} \[1 5\]:   |
| {:\(split-name :test, :\)split-id 0}   | 1         | Group: {:\(split-name :test, :\)split-id 0} \[24 5\]:   |
| {:\(split-name :train, :\)split-id 1}  | 2         | Group: {:\(split-name :train, :\)split-id 1} \[2 5\]:   |
| {:\(split-name :test, :\)split-id 1}   | 3         | Group: {:\(split-name :test, :\)split-id 1} \[23 5\]:   |
| {:\(split-name :train, :\)split-id 2}  | 4         | Group: {:\(split-name :train, :\)split-id 2} \[4 5\]:   |
| {:\(split-name :test, :\)split-id 2}   | 5         | Group: {:\(split-name :test, :\)split-id 2} \[21 5\]:   |
| {:\(split-name :train, :\)split-id 3}  | 6         | Group: {:\(split-name :train, :\)split-id 3} \[5 5\]:   |
| {:\(split-name :test, :\)split-id 3}   | 7         | Group: {:\(split-name :test, :\)split-id 3} \[20 5\]:   |
| {:\(split-name :train, :\)split-id 4}  | 8         | Group: {:\(split-name :train, :\)split-id 4} \[7 5\]:   |
| {:\(split-name :test, :\)split-id 4}   | 9         | Group: {:\(split-name :test, :\)split-id 4} \[18 5\]:   |
| {:\(split-name :train, :\)split-id 5}  | 10        | Group: {:\(split-name :train, :\)split-id 5} \[8 5\]:   |
| {:\(split-name :test, :\)split-id 5}   | 11        | Group: {:\(split-name :test, :\)split-id 5} \[17 5\]:   |
| {:\(split-name :train, :\)split-id 6}  | 12        | Group: {:\(split-name :train, :\)split-id 6} \[10 5\]:  |
| {:\(split-name :test, :\)split-id 6}   | 13        | Group: {:\(split-name :test, :\)split-id 6} \[15 5\]:   |
| {:\(split-name :train, :\)split-id 7}  | 14        | Group: {:\(split-name :train, :\)split-id 7} \[11 5\]:  |
| {:\(split-name :test, :\)split-id 7}   | 15        | Group: {:\(split-name :test, :\)split-id 7} \[14 5\]:   |
| {:\(split-name :train, :\)split-id 8}  | 16        | Group: {:\(split-name :train, :\)split-id 8} \[13 5\]:  |
| {:\(split-name :test, :\)split-id 8}   | 17        | Group: {:\(split-name :test, :\)split-id 8} \[12 5\]:   |
| {:\(split-name :train, :\)split-id 9}  | 18        | Group: {:\(split-name :train, :\)split-id 9} \[14 5\]:  |
| {:\(split-name :test, :\)split-id 9}   | 19        | Group: {:\(split-name :test, :\)split-id 9} \[11 5\]:   |
| {:\(split-name :train, :\)split-id 10} | 20        | Group: {:\(split-name :train, :\)split-id 10} \[16 5\]: |
| {:\(split-name :test, :\)split-id 10}  | 21        | Group: {:\(split-name :test, :\)split-id 10} \[9 5\]:   |
| {:\(split-name :train, :\)split-id 11} | 22        | Group: {:\(split-name :train, :\)split-id 11} \[17 5\]: |
| {:\(split-name :test, :\)split-id 11}  | 23        | Group: {:\(split-name :test, :\)split-id 11} \[8 5\]:   |
| {:\(split-name :train, :\)split-id 12} | 24        | Group: {:\(split-name :train, :\)split-id 12} \[19 5\]: |
...
| :name | :group-id | :data                            |
| ----- | --------- | -------------------------------- |
| :g3   | 0         | Group: :g3, (splitted) \[10 5\]: |
| :g1   | 1         | Group: :g1, (splitted) \[9 5\]:  |
| :g2   | 2         | Group: :g2, (splitted) \[12 5\]: |
...
\#function\[tablecloth.pipeline/select-columns/fn–39245\]
...
| ----- | ------ | ---- | ------------ | ----------- |
| 1     | JFK    | LAX  | 6.59036145   | 14.22891566 |
| 1     | LGA    | PBI  | \-7.75862069 | 0.31034483  |
| 1     | EWR    | LAX  | 1.36666667   | 7.50000000  |
| 1     | JFK    | MIA  | 15.72067039  | 18.74301676 |
| 1     | JFK    | SEA  | 14.35714286  | 30.75000000 |
| 1     | EWR    | MIA  | 11.01123596  | 12.12359551 |
| 1     | JFK    | SFO  | 19.25225225  | 28.63963964 |
| 1     | JFK    | BOS  | 12.91964286  | 15.21428571 |
| 1     | JFK    | ORD  | 31.58620690  | 40.17241379 |
| 1     | JFK    | IAH  | 28.85714286  | 14.28571429 |
...
| ---------- | ------ | --------- | ---- | ---------- | ---- | -------- | ---- | ----- | --- | ------- |
| 14         | JFK    | 359       | 9    | 13         | LAX  | 2475     | 2014 | 1     | 1   | AA      |
| \-3        | JFK    | 363       | 11   | 13         | LAX  | 2475     | 2014 | 1     | 1   | AA      |
| \-1        | JFK    | 358       | 8    | 1          | LAX  | 2475     | 2014 | 2     | 1   | AA      |
| \-5        | JFK    | 358       | 11   | 3          | LAX  | 2475     | 2014 | 2     | 1   | AA      |
| \-11       | JFK    | 375       | 8    | 36         | LAX  | 2475     | 2014 | 3     | 1   | AA      |
| \-3        | JFK    | 368       | 11   | 14         | LAX  | 2475     | 2014 | 3     | 1   | AA      |
