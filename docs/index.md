...
```
    ...
    ([#object[java.time.LocalDate 0x14f51d39 "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x48316f80 "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
...
```
    ...
    ({"date" #object[java.time.LocalDate 0x7814b994 "2012-01-01"],
      "precipitation" 0.0,
      "temp_min" 5.0,
      "weather" "drizzle",
      "temp_max" 12.8,
      "wind" 4.7}
     {"date" #object[java.time.LocalDate 0x73859b82 "2012-01-02"],
      "precipitation" 10.9,
      "temp_min" 2.8,
      "weather" "rain",
      "temp_max" 10.6,
...
| v1  | v2  | \[1 2 3\] | <java.lang.Object@3dd6fda> |
|-----|-----|-----------|----------------------------|
| 1   | 1   | 0.5000    | A                          |
| 2   | 2   | 1.000     | B                          |
| 1   | 3   | 1.500     | C                          |
...
| v1  | v2  | \[1 2 3\] | <java.lang.Object@7a7c1d86> |
|-----|-----|-----------|-----------------------------|
| 1   | 1   | 0.5000    | A                           |
| 1   | 3   | 1.500     | C                           |
| 1   | 5   | 1.000     | B                           |
...
```
    ...
    #object["[J" 0x79a0af93 "[J@79a0af93"]
...
```
    ...
    (#object["[J" 0x5a682f6d "[J@5a682f6d"] #object["[J" 0x6138a0c9 "[J@6138a0c9"] #object["[J" 0xb9fd148 "[J@b9fd148"])
...
```
    ...
    #object["[Ljava.lang.String;" 0x237cde06 "[Ljava.lang.String;@237cde06"]
    #object["[F" 0x38787628 "[F@38787628"]
...
| :x  | :a  | :b  | :y1    | :y2    | :z1 | :z2 |
|-----|-----|-----|--------|--------|-----|-----|
| 1   | 1   | 0   | 0.2996 | 0.9337 | 3   | -2  |
| 2   | 1   | 1   | 0.6238 | 0.1937 | 3   | -2  |
| 3   | 0   | 1   | 0.4669 | 0.3935 | 3   | -2  |
| 4   | 0   | 1   | 0.6988 | 0.9088 | 3   | -2  |
