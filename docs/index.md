...
[SOURCE CODE](https://github.com/sciclog/tablecloth/)
...
```
    ...
    ([#object[java.time.LocalDate 0x69b406c7 "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x73ed1fd "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
...
```
    ...
    ({"date" #object[java.time.LocalDate 0x4e6044a4 "2012-01-01"],
      "precipitation" 0.0,
      "temp_min" 5.0,
      "weather" "drizzle",
      "temp_max" 12.8,
      "wind" 4.7}
     {"date" #object[java.time.LocalDate 0x28d514e5 "2012-01-02"],
      "precipitation" 10.9,
      "temp_min" 2.8,
      "weather" "rain",
      "temp_max" 10.6,
...
| v1  | v2  | \[1 2 3\] | <java.lang.Object@3310c1d> |
|-----|-----|-----------|----------------------------|
| 1   | 1   | 0.5000    | A                          |
| 2   | 2   | 1.000     | B                          |
| 1   | 3   | 1.500     | C                          |
...
| v1  | v2  | \[1 2 3\] | <java.lang.Object@7511822f> |
|-----|-----|-----------|-----------------------------|
| 1   | 1   | 0.5000    | A                           |
| 1   | 3   | 1.500     | C                           |
| 1   | 5   | 1.000     | B                           |
...
```
    ...
    #object["[J" 0x7572b1a5 "[J@7572b1a5"]
...
```
    ...
    (#object["[J" 0x67deab2d "[J@67deab2d"] #object["[J" 0x5ecf0643 "[J@5ecf0643"] #object["[J" 0x43f64d69 "[J@43f64d69"])
...
```
    ...
    #object["[Ljava.lang.String;" 0x6c53c08a "[Ljava.lang.String;@6c53c08a"]
    #object["[F" 0x77574eed "[F@77574eed"]
...
| :x  | :a  | :b  | :y1    | :y2    | :z1 | :z2 |
|-----|-----|-----|--------|--------|-----|-----|
| 1   | 1   | 0   | 0.9542 | 0.4029 | 3   | -2  |
| 2   | 1   | 1   | 0.6049 | 0.8875 | 3   | -2  |
| 3   | 0   | 1   | 0.1480 | 0.6221 | 3   | -2  |
| 4   | 0   | 1   | 0.2656 | 0.1088 | 3   | -2  |
